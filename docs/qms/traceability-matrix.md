...
| Unsafe temperature telemetry blocks execution | `ITemperatureController` + `SimulationDeviceFacade` + `SafetyKernel` | `SafetyKernelTests::temperatureFaultForcesRedInterlock`, `SimulationDeviceFacadeTests::blocksTemperatureWhenFaulted` |
| LU-926UT6Y register conversion remains deterministic | `Lu926TemperatureProtocol` | `SimulationDeviceFacadeTests::mapsLu926TemperatureRegisters` |
