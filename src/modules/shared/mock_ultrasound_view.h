...
public:
    ...
    void setSyntheticImageEnabled(bool enabled);
    bool isSyntheticImageEnabled() const;
    void setBackgroundImage(const QPixmap& image);
    void clearBackgroundImage();
    void setBackgroundImageStretchToFill(bool enabled);
    bool isBackgroundImageStretchToFill() const;
    ...
    void setScaleRulerEnabled(bool enabled);
    bool isScaleRulerEnabled() const;
    void setScaleRulerExpanded(bool expanded);
    bool isScaleRulerExpanded() const;
...
private:
    ...
    QRectF scaleRulerToggleRect() const;
    QRectF scaleRulerRect() const;
    ...
    void drawScaleRuler(QPainter* painter);
    ...
    QString m_caption;
    bool m_syntheticImageEnabled {true};
    QPixmap m_backgroundImage;
    bool m_backgroundImageStretchToFill {false};
    bool m_imageZoomEnabled {false};
    qreal m_imageZoomFactor {1.0};
    QPointF m_imageZoomCenterNormalized {0.5, 0.5};
    bool m_scaleRulerEnabled {false};
    bool m_scaleRulerExpanded {true};
    int m_sliceIndex {0};
